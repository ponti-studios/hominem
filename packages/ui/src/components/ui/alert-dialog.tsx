...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 grid w-full max-w-lg scale-100 gap-4 border p-6 opacity-100 shadow-lg animate-in fade-in-90 slide-in-from-bottom-10 sm: sm:zoom-in-90 sm:slide-in-from-bottom-0',
        className,
      )}
      {...props}
    />
