...
describe('Chat', () => {
  ...
  test('renders without crashing', async () => {
    testServer.use(http.get(mockEndpoint, () => HttpResponse.json({ messages: [] })))
    ...
    await waitFor(() => {
      expect(screen.queryByText(`${mockEmoji} ${mockTitleText}`)).toBeInTheDocument()
    })
  })
  ...
  test.skip('sends a message when the form is submitted', async () => {
    ...
    await waitFor(() => expect(screen.getByTestId('chat')).toHaveTextContent('Test message'))
  })
})
