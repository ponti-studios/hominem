...
>) {
  ...
  if (type === 'warning') {
    return (
      <div
        className={twMerge('rounded-md bg-yellow-400 text-warning-content p-4 text-md', className)}
      >
        {children}
      </div>
    )
  ...
  return (
    <div className={twMerge('rounded-md bg-gray-100 text-info-content p-4 text-md', className)}>
      {children}
    </div>
  )
}
