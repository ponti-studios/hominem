...
export async function generateTimeSeriesData(
  ...
  // Get monthly summaries from the transaction analytics service
 ...
 */
export async function generateWeeklyTimeSeriesData(
  options: QueryOptions & {
    compareToPrevious?: boolean
    includeStats?: boolean
  }
): Promise<TimeSeriesResponse> {
  // This would need to be implemented with a different query
  // For now, we'll use the monthly data and group it differently
  return generateTimeSeriesData({ ...options, groupBy: 'week' })
}

/**
 * Generate daily time series data
 */
export async function generateDailyTimeSeriesData(
  options: QueryOptions & {
    compareToPrevious?: boolean
    includeStats?: boolean
  }
  ...
  // This would need to be implemented with a different query
  // For now, we'll use the monthly data and group it differently
  return generateTimeSeriesData({ ...options, groupBy: 'day' })
}
