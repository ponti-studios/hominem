...
export function OtpVerificationForm({
  ...
  const handleResend = () => {
    ...
    if (onResend) {
      ...
      void onResend(resolvedEmail).catch((caughtError) => {
        setResendError(
          caughtError instanceof Error ? caughtError.message : 'Failed to resend verification code.',
        );
      }).finally(() => {
      ...
      <form
        ...
        onSubmit={(event) => {
          ...
          void onSubmit({
            ...
            setSubmitError(
              caughtError instanceof Error ? caughtError.message : 'Verification failed. Please try again.',
            );
          }).finally(() => {
