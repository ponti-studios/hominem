...
export const getPlaceDetails = async ({
  ...
  const cacheKey = buildCacheKey({ path: 'places-details', placeId, fieldMask })
...
export const searchPlaces = async ({
  ...
  const cacheKey = buildCacheKey({ path: 'search', query, locationBias, fieldMask, maxResultCount })
