...
public struct AddNoteControlCenterIntent: AppIntent {
  ...
  public static let description = IntentDescription("Open Omiro to create a new note.")
...
public struct StartChatControlCenterIntent: AppIntent {
  ...
  public static let description = IntentDescription("Open the Omiro AI assistant.")
