  ...
  return (
    <View style={styles.container}>
      <View style={styles.section}>
        <Text variant="cardHeader" color="foreground">FOCUS INSIGHTS</Text>
        <Text variant="body" color="secondaryForeground">
          LIVE SUMMARY OF FOCUS STATE.
        </Text>
      </View>
      <View style={styles.section}>
        <Text variant="label" color="mutedForeground">LIVE METRICS</Text>
        <View style={styles.metricRow}>
          <MindsherpaIcon name="sparkles" size={18} color={theme.colors.foreground} />
          <Text variant="bodyLarge" color="foreground">ENERGY: HIGH</Text>
        </View>
        <View style={styles.metricRow}>
          <MindsherpaIcon name="bolt" size={18} color={theme.colors.foreground} />
          <Text variant="bodyLarge" color="foreground">MOMENTUM: 4 STREAKS</Text>
        </View>
      </View>
      <View style={styles.section}>
        <Text variant="label" color="mutedForeground">SHERPA REMINDER</Text>
        <Text variant="body" color="secondaryForeground">
