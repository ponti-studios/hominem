...
That error usually means the iOS workspace has not been generated yet, or CocoaPods have not been installed for the local `apps/mobile/ios` directory.
...
If the error still appears, the local generated `apps/mobile/ios` directory is likely stale and should be regenerated.
...
| Check the mobile app docs | `apps/mobile/README.md` | When Zed or Swift diagnostics get confused |
