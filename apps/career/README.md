...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/craftd_dev just db-migrate
...
| Run shared migrations        | `DATABASE_URL=postgresql://postgres:postgres@localhost:5432/craftd_dev just db-migrate` |
