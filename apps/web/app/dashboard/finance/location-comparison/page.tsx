										...
										{locations.map((loc, index) => (
											...
											>
												...
												<td className="text-right p-2">
													{formatCurrency(loc.annualGrossIncome)}
												</td>
												<td className="text-right p-2">
													{formatPercent(loc.taxRate)}
												</td>
												<td className="text-right p-2">
													{formatCurrency(loc.monthlyNetIncome)}
												</td>
												<td className="text-right p-2">
													{formatPercent(loc.savingsRate)}
												</td>
												<td className="text-right p-2">
													{formatCurrency(loc.housing)}
												</td>
												<td className="text-right p-2">
													{formatCurrency(loc.utilities)}
												</td>
												<td className="p-2">
													<Button
														variant="ghost"
										...
										<tbody>
											{locations.map((loc, index) => {
												...
												const equivalentSalary =
													(loc.costIndex / baseLocation.costIndex) *
													baseLocation.annualGrossIncome;

												return (
													<tr key={loc.id} className="border-b">
														<td className="p-2">{loc.place}</td>
														<td className="text-right p-2">
															{formatPercent(loc.costIndex)}
														</td>
														<td className="text-right p-2">
															{formatPercent(relativeCol)}
														</td>
														<td className="text-right p-2">
