...
export function Reasoning({ reasoning }: ReasoningProps) {
  return (
    <div data-testid="message-reasoning">
      <Card className="border-primary/10 hover:border-primary/20 transition-all duration-200 hover:shadow-md">
        <div className="p-3 space-y-2">
          ...
          <div className="relative group">
            ...
            <div
              className="relative text-sm text-muted-foreground p-2"
