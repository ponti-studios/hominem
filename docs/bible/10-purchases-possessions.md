...
Purchases are sensitive when they reveal finances or location. AI evidence is bounded to product/possession label, lifecycle state, and provenance; receipts remain private files.
...
- [ ] MCP possession context returns bounded lifecycle and provenance evidence, not receipt dumps.
