...
- **Schema:** [schema/08-health.sql](schema/08-health.sql)
- **Repository and service:** own health-record queries and highly-sensitive data minimization.
- **MCP:** no external health tool in v1; require an explicit future consent and safety plan before enabling one.
