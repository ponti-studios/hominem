...
- **Schema:** [schema/12-music.sql](schema/12-music.sql)
- **Repository and service:** preserve provider-scoped catalog identity, playlist ordering, and listen semantics.
- **MCP:** after Plan 00, return bounded listening context and recency evidence, not listen logs.
...
None. This plan is split out of [09-media-reading.md](09-media-reading.md) because music behaves like a dedicated product domain.
