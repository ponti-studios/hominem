...
**Change:** <change-name>
**Target:** remove `openspec/changes/<name>` after merged outputs are finalized

The raw change folder could not be removed cleanly.

**Options:**
1. Check for open files or permissions
2. Remove the folder manually if it's a duplicate
3. Retry after verifying merged outputs are complete
```
