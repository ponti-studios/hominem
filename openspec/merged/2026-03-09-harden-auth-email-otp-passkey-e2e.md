# harden-auth-email-otp-passkey-e2e

## 1. Project Metadata

| Field | Value |
| --- | --- |
| Change Slug | harden-auth-email-otp-passkey-e2e |
...
| --- | --- | --- |
| openspec/merged/2026-03-09-harden-auth-email-otp-passkey-e2e.md | added | Canonical merged completion document |
| openspec/changes/archive/2026-03-06-harden-auth-email-otp-passkey-e2e/proposal.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-06-harden-auth-email-otp-passkey-e2e/design.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-06-harden-auth-email-otp-passkey-e2e/tasks.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-06-harden-auth-email-otp-passkey-e2e/specs/* | retained | Capability delta/audit records |
| openspec/changes/archive/2026-03-06-harden-auth-email-otp-passkey-e2e/PROGRESS.md | retained if present | Historical implementation tracking |
...
| Template compliance | Generated doc matches merged template structure | pass | openspec/merged/2026-03-09-harden-auth-email-otp-passkey-e2e.md |
| Retention policy | Durable artifacts retained | pass | openspec/changes/archive/2026-03-06-harden-auth-email-otp-passkey-e2e/specs, openspec/changes/archive/2026-03-06-harden-auth-email-otp-passkey-e2e/PROGRESS.md (if present) |
...
| tasks.md | present | ## 1. Auth Test Foundation |
