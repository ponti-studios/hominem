# remove-mock-apple-auth-add-passkey

## 1. Project Metadata

| Field | Value |
| --- | --- |
| Change Slug | remove-mock-apple-auth-add-passkey |
...
| --- | --- | --- |
| openspec/merged/2026-03-09-remove-mock-apple-auth-add-passkey.md | added | Canonical merged completion document |
| openspec/changes/archive/2026-03-07-remove-mock-apple-auth-add-passkey/proposal.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-07-remove-mock-apple-auth-add-passkey/design.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-07-remove-mock-apple-auth-add-passkey/tasks.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-07-remove-mock-apple-auth-add-passkey/specs/* | retained | Capability delta/audit records |
| openspec/changes/archive/2026-03-07-remove-mock-apple-auth-add-passkey/PROGRESS.md | retained if present | Historical implementation tracking |
...
| Template compliance | Generated doc matches merged template structure | pass | openspec/merged/2026-03-09-remove-mock-apple-auth-add-passkey.md |
| Retention policy | Durable artifacts retained | pass | openspec/changes/archive/2026-03-07-remove-mock-apple-auth-add-passkey/specs, openspec/changes/archive/2026-03-07-remove-mock-apple-auth-add-passkey/PROGRESS.md (if present) |
...
| tasks.md | present | ## 1. Remove Mock Authentication |
