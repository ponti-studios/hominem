...
| Field | Value |
| --- | --- |
| Change Slug | phased-db-redesign |
...
| --- | --- | --- |
| openspec/merged/2026-03-09-phased-db-redesign.md | added | Canonical merged completion document |
| openspec/changes/archive/2026-03-07-phased-db-redesign/proposal.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-07-phased-db-redesign/design.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-07-phased-db-redesign/tasks.md | removed if present | Superseded by merged doc |
| openspec/changes/archive/2026-03-07-phased-db-redesign/specs/* | retained | Capability delta/audit records |
| openspec/changes/archive/2026-03-07-phased-db-redesign/PROGRESS.md | retained if present | Historical implementation tracking |
...
| Template compliance | Generated doc matches merged template structure | pass | openspec/merged/2026-03-09-phased-db-redesign.md |
| Retention policy | Durable artifacts retained | pass | openspec/changes/archive/2026-03-07-phased-db-redesign/specs, openspec/changes/archive/2026-03-07-phased-db-redesign/PROGRESS.md (if present) |
...
| tasks.md | present | ## 1. Audit & Discovery |
