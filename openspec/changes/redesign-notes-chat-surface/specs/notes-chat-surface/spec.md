...
### Requirement: Notes chat SHALL use a shared cross-platform presentation contract
The Notes chat redesign SHALL define a shared presentation contract across the web Notes app and the mobile app, with canonical chat semantics and tokenized layout rules owned by the shared UI layer.
